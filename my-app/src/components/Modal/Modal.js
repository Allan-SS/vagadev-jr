...
import { BtnClose, ContainerConfirma, ContainerModal, ContainerTextConfirma, ImgConfirmBuy } from "./styled";
...
const Modal = (props) => {
    ...
    return(
        <ContainerModal id="opacity">
            <ContainerConfirma>
                <BtnClose src={IconClose} onClick={() => props.close(!props.showModal)} alt="Close"/>
